...
class DischargeSummary(models.Model):
    ...
    provisionalDiagnosis = models.TextField(max_length = 4000 , null = True , blank = True)
    finalDiagnosis = models.TextField(max_length = 4000 , null = True  , blank = True)
    complaintsAndReason = models.TextField(max_length = 4000 , null = True  , blank = True)
    summIllness = models.TextField(max_length = 4000 , null = True  , blank = True)
    keyFindings = models.TextField(max_length = 4000 , null = True , blank = True)
    historyOfAlchohol = models.TextField(max_length = 4000 , null = True , blank = True)
    pastHistory = models.TextField(max_length = 4000 , null = True , blank = True)
    familyHistory = models.TextField(max_length = 4000 , null = True , blank = True)
    summaryKeyInvestigation = models.TextField(max_length = 4000 , null = True , blank = True)
    courseInHospital = models.TextField(max_length = 4000 , null = True , blank = True)
    patientCondition= models.TextField(max_length = 4000 , null = True , blank = True)
    advice = models.TextField(max_length =4000 , null = True , blank = True)
    reviewOn = models.TextField(max_length = 4000 , null = True , blank = True)
    complications = models.TextField(max_length = 4000 , null = True , blank = True)
    treatmentGiven = models.TextField(max_length = 4000 , null = True , blank = True)

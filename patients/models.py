...
class DischargeSummary(models.Model):
    ...
    provisionalDiagnosis = models.CharField(max_length = 6000 , null = True , blank = True)
    finalDiagnosis = models.CharField(max_length = 6000 , null = True  , blank = True)
    complaintsAndReason = models.CharField(max_length = 6000 , null = True  , blank = True)
    summIllness = models.CharField(max_length = 6000 , null = True  , blank = True)
    keyFindings = models.CharField(max_length = 6000 , null = True , blank = True)
    historyOfAlchohol = models.CharField(max_length = 6000 , null = True , blank = True)
    pastHistory = models.CharField(max_length = 6000 , null = True , blank = True)
    familyHistory = models.CharField(max_length = 6000 , null = True , blank = True)
    summaryKeyInvestigation = models.CharField(max_length = 6000 , null = True , blank = True)
    courseInHospital = models.CharField(max_length = 6000 , null = True , blank = True)
    patientCondition= models.CharField(max_length = 6000 , null = True , blank = True)
    advice = models.CharField(max_length =6000 , null = True , blank = True)
    reviewOn = models.CharField(max_length = 6000 , null = True , blank = True)
    complications = models.CharField(max_length = 6000 , null = True , blank = True)
    treatmentGiven = models.CharField(max_length = 6000 , null = True , blank = True)

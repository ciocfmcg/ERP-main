app.config(function($stateProvider){
  $stateProvider.state('businessManagement.employees.orgChart', {
    url: "/orgChart",
    templateUrl: '/static/ngTemplates/app.employees.orgChart.html',
    controller: 'businessManagement.employees.orgChart'
  });
});
app.controller("businessManagement.employees.orgChart", function($scope, $state, $users, $stateParams, $http, Flash , $timeout) {

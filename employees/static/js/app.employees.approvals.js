app.config(function($stateProvider) {
  $stateProvider.state('businessManagement.employees.approvals', {
    url: "/approvals",
...
app.controller("businessManagement.employees.approvals.info", function($scope, $state, $users, $stateParams, $http, Flash, $timeout) {
...
app.controller("businessManagement.employees.timeSheet.info", function($scope, $state, $users, $stateParams, $http, Flash, $timeout) {
...
app.controller("businessManagement.employees.approvals", function($scope, $state, $users, $stateParams, $http, Flash, $timeout) {

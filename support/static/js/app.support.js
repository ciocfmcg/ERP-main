...
app.controller("businessManagement.support", function($scope, $state, $users, $stateParams, $http, Flash , $timeout, $interval , $uibModal) {
     ...
     $scope.newUsers = [
       {name : 'visitor1',messages : [{msg : "Hello , how are you?",sentByMe:false , created: new Date() } , {msg : "fine! you tell..",sentByMe:true, created: new Date()} ,  {msg : "nothin much, How about you?",sentByMe:false, created: new Date()} ,  {msg : "Let's go to Goa this weekend!",sentByMe:true, created: new Date()} , {msg : "",sentByMe:false, videoUrl:'/static/videos/24tutors.mp4' , created: new Date()} ],email:"visitor1@gmail.com",address:"Siliguri,west bengal",location:"78.108.48.149",time:"4.20 pm",chattime:"17.02",isOnline:true, uid:'24Tutors$123$f'},
       ...
       {name : 'visitor6',messages : [{msg : "",sentByMe:false, videoUrl:'/static/videos/24tutors.mp4' , created: new Date()}],email:"visitor7@gmail.com",address:"Barasat,west bengal",location:"56.178.65.149",time:"6.20 pm",chattime:"12.02",isOnline:false, uid:'rackmint$678$c'},
     ...
     $scope.myUsers =[
         {name : 'visitor0',messages : [{msg : "hi",sentByMe:false , created: new Date()} , {msg : "",sentByMe:true,img:'/static/images/career.jpg' , created: new Date()} , {msg : "Looks Great!",sentByMe:false , created: new Date()}],email:"visitor@gmail.com",address:"islampur,west bengal",location:"78.108.48.149",time:"4.20 pm",chattime:"17.02",isOnline:true, uid:'monomerce$000$s'},
     ];

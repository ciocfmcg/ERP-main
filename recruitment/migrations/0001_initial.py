    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='position_a', to='organization.Roles')),
                ('unit', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='unit_a', to='organization.Units')),
            ],
        ),
    ]
